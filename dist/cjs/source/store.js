        ...
        return asAsync(function* () {
            ...
            if (oldId === undefined) {
                ...
                wrapped = global_1.defineProperty(Object.assign(rx_utils_1.eagerCombineAll(obs, obs.origin.subject.pipe(operators_1.scan((acc, { args, n }) => {
                    ...
                    return v === w;
                })))).pipe(operators_1.finalize(() => { unload?.(); clear(); this.map.delete(id); destroyed = true; }), operators_1.map(([v]) => v), operators_1.shareReplay({ bufferSize: 1, refCount: true })), { origin: obs.origin, parent: obs }), 'destroyed', { get() { return destroyed; } });
