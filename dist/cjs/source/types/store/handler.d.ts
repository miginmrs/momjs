...
export declare type RequestHandleDecodeX<dom, cim extends TVCDA_CIM, k extends TVCDADepConstaint<dom, cim>, X extends dom, n extends 1 | 2, EH extends EHConstraint<EH, ECtx>, ECtx> = {
    (id: string, args: AppX<'T', cim, k, X>, old: SerialObs<dom, cim, k, X, n, EH, ECtx> | null): EntryObs<AppX<'D', cim, k, X>, AppX<'A', cim, k, X>, n, EH, ECtx>;
};
export declare type RequestHandleDecodes<dom extends keytype, cim extends TVCDA_CIM, k extends TVCDADepConstaint<dom, cim>, n extends 1 | 2, EH extends EHConstraint<EH, ECtx>, ECtx> = {
    [X in dom]: RequestHandleDecodeX<dom, cim, k, X, n, EH, ECtx>;
};
export declare type RequestHandleDecode<dom, cim extends TVCDA_CIM, k extends TVCDADepConstaint<dom, cim>, n extends 1 | 2, EH extends EHConstraint<EH, ECtx>, ECtx> = {
...
export declare type CtxH<dom, cim extends TVCDA_CIM, k extends TVCDADepConstaint<dom, cim>, n extends 1 | 2, EH extends EHConstraint<EH, ECtx>, ECtx> = CtxEH<dom, cim, k, n, EH, ECtx> & {
    ...
    } & ECtx) => RequestHandleDecode<dom, cim, k, n, EH, ECtx>;
