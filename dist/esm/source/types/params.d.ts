...
export declare type CondRefHelper<C, X> = RefHelper<C & ParentOfC, X & number>;
export declare type GlobalRefHelper<indices extends number, C extends ParentOfC> = {
    [i in indices]: RefHelper<C, i & number>;
} & GlobalRef<unknown>[];
