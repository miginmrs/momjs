...
export declare type ArrayHandler<EH extends EHConstraint<EH, ECtx>, ECtx> = CtxH<unknown[], ArrayCim, ArrayTypeKeys, 1, EH, ECtx>;
export declare const ArrayHandler: <EH extends EHConstraint<EH, ECtx>, ECtx>() => CtxH<unknown[], ArrayCim, ArrayTypeKeys, 1, EH, ECtx>;
export declare type ArrayDestructable<A extends unknown[], EH extends EHConstraint<EH, ECtx>, ECtx> = Destructable<unknown[], ArrayCim, ArrayTypeKeys, A, 1, EH, ECtx>;
...
export declare const toArray: <EH extends EHConstraint<EH, ECtx> & {
    Array: CtxH<unknown[], ArrayCim, ArrayTypeKeys, 1, EH, ECtx>;
}, ECtx>(deref: deref<EH, ECtx>) => <T>(p: Ref<T[]>) => Destructable<unknown[], ArrayCim, ArrayTypeKeys, T[], 1, EH, ECtx>;
